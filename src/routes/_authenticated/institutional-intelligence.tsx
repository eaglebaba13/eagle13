    ...
    <div className="mx-auto max-w-6xl space-y-6 p-4 md:p-8">
      <header className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Aggregated institutional context: FII/DII, macro, global markets, sector rotation, news
          and a probability layer. Analytical only — does not replace the Decision Engine.
        </p>
      </header>

      <Section id="sec-flow" title="Institutional Flow (FII / DII)">
        Official values only. When the provider is unavailable this section is marked UNAVAILABLE —
        never estimated.
      </Section>
      <Section id="sec-macro" title="Macro Dashboard">
        USD/INR · DXY · US10Y · Crude · Natural Gas · Gold · Silver. Macro risk is classified LOW /
        MEDIUM / HIGH.
      </Section>
      ...
      <Section id="sec-news" title="Latest News">
        Normalized to sentiment and impact. No fabricated headlines — provider outages surface as
        UNAVAILABLE.
      </Section>
      <Section id="sec-prob" title="Institutional Probability">
        Independent analytical layer combining FII/DII, macro, sector rotation, global markets, VIX,
        breadth, PCR and news.
      </Section>
      <Section id="sec-fresh" title="Freshness Monitor">
        Every section exposes LIVE / FRESH / STALE / PARTIAL / UNAVAILABLE. Stale data is never
        labelled LIVE.
      </Section>
    </div>
  );
