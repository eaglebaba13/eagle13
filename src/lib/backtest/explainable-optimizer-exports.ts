...
export function buildOptimizerSummaryCsv(r: OptimizerResult, p: OptimizerExportProvenance): string {
...
export function buildOptimizerAlternativesCsv(
  ...
  for (const a of r.alternatives) {
    rows.push([
      a.label,
      JSON.stringify(a.center),
      a.objectiveScore.toFixed(4),
      a.meanExpectancy.toFixed(4),
      a.meanDrawdown.toFixed(4),
      a.meanTrades.toFixed(2),
      a.monteCarloP5.toFixed(2),
      a.overfitRisk,
      a.confidence,
      a.expectedBehavior,
    ]);
...
export function buildOptimizerJson(r: OptimizerResult, p: OptimizerExportProvenance): string {
