// Phase 3C — User subscription defaults and helpers. Pure.

import type { AlertPriority, AlertSubscription, AlertType } from "./types";
...
export function subscriptionMatches(
...
): { ok: true } | { ok: false; reason: "SUBSCRIPTION_DISABLED" | "MIN_PRIORITY" } {
  ...
  // Priority checked by caller with meetsMinimumPriority.
  void priority;
  return { ok: true };
}