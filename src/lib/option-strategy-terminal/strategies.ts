...
export const STRATEGY_CATALOGUE: readonly StrategyProfile[] = [
  {
    ...
    legs: 1,
    bias: "BULL",
    volatilityStance: "LONG_VOL",
    capital: "LOW",
    risk: "LOW",
    reward: "UNLIMITED",
    complexity: "SIMPLE",
    preferredVix: ["LOW", "MID"],
    preferredStrikeRegime: ["ITM", "ATM"],
    summary: "Long call, defined risk, unlimited upside.",
  },
  {
    key: "BUY_PE",
    label: "Buy Put (PE)",
    ...
    preferredVix: ["LOW", "MID"],
    preferredStrikeRegime: ["ITM", "ATM"],
    summary: "Long put, defined risk, high downside profit potential.",
  },
  {
    key: "SELL_CE",
    label: "Sell Call (CE)",
    legs: 1,
    bias: "BEAR",
    volatilityStance: "SHORT_VOL",
    capital: "HIGH",
    risk: "UNLIMITED",
    reward: "LOW",
    complexity: "MODERATE",
    preferredVix: ["MID", "HIGH"],
    preferredStrikeRegime: ["OTM"],
    summary: "Short call, premium collection, unlimited risk.",
  },
  {
    key: "SELL_PE",
    label: "Sell Put (PE)",
    ...
    preferredVix: ["MID", "HIGH"],
    preferredStrikeRegime: ["OTM"],
    summary: "Short put, premium collection, defined-but-large risk.",
  },
  {
    ...
    complexity: "MODERATE",
    preferredVix: ["LOW", "MID"],
    preferredStrikeRegime: ["ATM", "ITM"],
    summary: "Long CE + short higher CE; capped reward, low cost.",
  },
  {
    key: "BEAR_PUT_SPREAD",
    ...
    preferredVix: ["LOW", "MID"],
    preferredStrikeRegime: ["ATM", "ITM"],
    summary: "Long PE + short lower PE; capped reward, low cost.",
  },
  {
    key: "BULL_PUT_SPREAD",
    ...
    preferredVix: ["MID", "HIGH"],
    preferredStrikeRegime: ["OTM"],
    summary: "Credit spread favouring an up/sideways move.",
  },
  {
    ...
    preferredVix: ["MID", "HIGH"],
    preferredStrikeRegime: ["OTM"],
    summary: "Credit spread favouring a down/sideways move.",
  },
  {
    key: "LONG_STRADDLE",
    label: "Long Straddle",
    ...
    complexity: "MODERATE",
    preferredVix: ["LOW"],
    preferredStrikeRegime: ["ATM"],
    summary: "ATM CE + ATM PE; profits on a large move either way.",
  },
  {
    key: "SHORT_STRADDLE",
    ...
    preferredVix: ["HIGH"],
    preferredStrikeRegime: ["ATM"],
    summary: "Sell ATM CE + PE; profits on range-bound expiry.",
  },
  {
    key: "LONG_STRANGLE",
    label: "Long Strangle",
    ...
    preferredVix: ["LOW"],
    preferredStrikeRegime: ["OTM"],
    summary: "OTM CE + OTM PE; cheap tail-event long-vol bet.",
  },
  {
    key: "SHORT_STRANGLE",
    ...
    preferredVix: ["HIGH"],
    preferredStrikeRegime: ["OTM"],
    summary: "Short OTM CE + PE; range-bound premium harvest.",
  },
  {
    key: "IRON_CONDOR",
    label: "Iron Condor",
    ...
    preferredVix: ["MID", "HIGH"],
    preferredStrikeRegime: ["OTM"],
    summary: "Two vertical credit spreads; range-bound trades.",
  },
  {
    key: "IRON_FLY",
    label: "Iron Fly",
    ...
    preferredVix: ["HIGH"],
    preferredStrikeRegime: ["ATM"],
    summary: "ATM short straddle + protective wings.",
  },
  {
    key: "CALENDAR_SPREAD",
    ...
    preferredVix: ["LOW", "MID"],
    preferredStrikeRegime: ["ATM"],
    summary: "Sell near-expiry, buy far-expiry same strike.",
  },
  {
    key: "DIAGONAL_SPREAD",
    ...
    complexity: "ADVANCED",
    preferredVix: ["LOW", "MID"],
    preferredStrikeRegime: ["ATM", "OTM"],
    summary: "Different strike + different expiry; directional-vol tilt.",
  },
  {
    key: "RATIO_SPREAD",
    label: "Ratio Spread",
    ...
    preferredVix: ["MID"],
    preferredStrikeRegime: ["OTM"],
    summary: "Unequal leg count; directional with vol overlay.",
  },
  {
    key: "BUTTERFLY",
    label: "Butterfly",
    ...
    preferredVix: ["MID"],
    preferredStrikeRegime: ["ATM"],
    summary: "Cheap pin-strike, low-risk range bet.",
  },
  {
    ...
    preferredVix: ["MID"],
    preferredStrikeRegime: ["ATM", "OTM"],
    summary: "Skewed butterfly with directional bias.",
  },
  {
    key: "JADE_LIZARD",
    label: "Jade Lizard",
    ...
    preferredVix: ["MID", "HIGH"],
    preferredStrikeRegime: ["OTM"],
    summary: "Short put + short call spread; no upside risk.",
  },
];
...
function propensity(p: StrategyProfile): { bull: number; bear: number; neu: number } {
  switch (p.bias) {
    case "BULL":
      return { bull: 90, bear: 5, neu: 20 };
    case "BEAR":
      return { bull: 5, bear: 90, neu: 20 };
    case "NEUTRAL":
      return { bull: 30, bear: 30, neu: 90 };
    case "VOL_LONG":
      return { bull: 55, bear: 55, neu: 25 };
    case "VOL_SHORT":
      return { bull: 45, bear: 45, neu: 80 };
  }
}
...
function alignmentFor(profile: StrategyProfile, direction: DirectionResult): number {
  ...
  switch (direction.bias) {
    ...
    case "NEUTRAL":
      return p.neu;
    case "CONFLICT":
      return Math.min(p.bull, p.bear); // conservative
    case "UNAVAILABLE":
      return 0;
  }
}
...
export function scoreStrategies(
  ...
  for (const profile of STRATEGY_CATALOGUE) {
    ...
    if (direction.bias !== "UNAVAILABLE" && direction.bias !== "CONFLICT") {
      rationale.push(
        `Direction ${direction.bias.toLowerCase()} (confidence ${direction.confidence}%).`,
      );
    } else {
    ...
    if (vixRegime !== "UNKNOWN") {
      rationale.push(
        profile.preferredVix.includes(vixRegime)
    ...
    if (strikeRegime !== "UNKNOWN") {
      rationale.push(
        profile.preferredStrikeRegime.includes(strikeRegime)
...
export function runStrategyEngine(input: StrategyEngineInput): StrategyEngineOutput {
  ...
  if (direction.bias === "UNAVAILABLE")
    reasons.push("No canonical signals available — recommendations suppressed.");
  else if (direction.bias === "CONFLICT")
    reasons.push("Canonical signals conflict — recommendations suppressed.");
