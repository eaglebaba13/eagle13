...
const panchang: PanchangBundle = {
  ...
  yoga: "Siddhi",
  karana: "Bava",
  nextNewMoon: "2026-08-05",
  daysToNewMoon: 14,
  nextFullMoon: "2026-07-24",
  daysToFullMoon: 2,
  calculatedAt: "2026-07-22T02:45:00Z",
...
function baseInput() {
  return {
    ...
    generatedAt: "2026-07-22T02:45:00Z",
    reportId: buildReportId("2026-07-22"),
    panchang,
    nifty: iblock("NIFTY", "NIFTY 50"),
    banknifty: iblock("BANKNIFTY", "BANKNIFTY"),
    xauusd: iblock("XAUUSD", "XAU/USD"),
    xagusd: iblock("XAGUSD", "XAG/USD"),
    btc: iblock("BTC", "Bitcoin"),
    eth: iblock("ETH", "Ethereum"),
    ratio,
    indiaContext: india,
    fiiDii: fii,
