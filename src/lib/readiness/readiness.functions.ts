    ...
    const results = [
      ...
      ...auditRls({
        ...
        functions: [
          ...
          {
            name: "admin_approve_manual_payment",
            securityDefiner: true,
            searchPathSet: true,
            callableByAnon: false,
          },
        ],
        rlsEnabledTables: [
          "profiles",
      ...
      ...auditPaymentReadiness({
        ...
        upiConfigured: envVars
          .filter((v) => v.category === "payments" && v.required)
          .every((v) => v.status === "PRESENT"),
...
const KNOWN_ROUTES: RouteAuthSpec[] = [
  ...
  { path: "/decision", access: "public", guardKind: "public", serverAuthorized: true },
  {
    ...
    guardKind: "_authenticated",
    serverAuthorized: true,
  },
  {
    path: "/_authenticated/billing",
    access: "authenticated",
    guardKind: "_authenticated",
    serverAuthorized: true,
  },
  ...
  {
    path: "/_authenticated/admin/payments",
    access: "admin",
    guardKind: "_authenticated",
    serverAuthorized: true,
  },
  {
    path: "/_authenticated/admin/readiness",
    access: "admin",
    guardKind: "_authenticated",
    serverAuthorized: true,
  },
