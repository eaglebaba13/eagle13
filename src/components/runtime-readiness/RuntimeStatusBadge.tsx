...
const STATUS_TONE: Record<string, string> = {
  ...
  UNAVAILABLE: "bg-red-500/10 text-red-200 border-red-500/30",
  DEMO: "bg-sky-500/15 text-sky-300 border-sky-500/40",
  UNKNOWN: "bg-muted text-muted-foreground border-border/60",
  READY: "bg-emerald-500/15 text-emerald-300 border-emerald-500/40",
  PARTIALLY_READY: "bg-amber-500/15 text-amber-300 border-amber-500/40",
  NOT_READY: "bg-red-500/15 text-red-300 border-red-500/40",
